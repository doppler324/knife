...
var changeTextCartButton = function(){
	//each basket elements
	$('.addCart').each(function(index, nextElement){
		var $currentButton = $('.addCart');		
		$currentButton.text("Подробнее");
	});
		...
		$.getJSON(ajaxPath + "?act=selectSku&props=" + encodeURIComponent(_props) + "&params=" + encodeURIComponent(_params) + "&level=" + _level + "&iblock_id=" + $_mProduct.data("iblock-id") + "&prop_id=" + $_mProduct.data("prop-id") + "&product_id=" + $_mProduct.data("product-id") + "&highload=" + encodeURIComponent(_highload) + "&product_width=" + _product_width + "&product_height=" + _product_height + "&product-change-prop=" + $_mProduct.data("change-prop") + "&product-more-pictures=" + $_mProduct.data("more-pictures") + "&price-code=" + encodeURIComponent($_mProductContainer.data("price-code")))
		  .done(function(http){
			...
			if($_mProduct.data("cast-func")){
				...
				$changeCart.find("img").remove();
				if(http[0]["PRODUCT"]["PRICE"]["DISCOUNT_PRICE"]){
					$changeCart.removeClass("added").removeClass("disabled").removeClass("requestPrice").html($("<span/>").html("Узнать скидку поставщика").prepend($("<img />").attr({src: TEMPLATE_PATH + "/images/incart.svg", class: "icon"}))).attr("href", 'https://ad.admitad.com/g/17lxnyyakg5082102477c109c80522/?subid=elem_' + http[0]['PRODUCT']['ID'] + '&ulp=' + http[0]["PRODUCT"]["PROPERTIES"]["URL_PRODUCT"]["VALUE"]);
					$_mProduct.find(".fastBack").attr("href", 'https://ad.admitad.com/g/17lxnyyakg5082102477c109c80522/?subid=elem_' + http[0]['PRODUCT']['ID'] + '&ulp=' + http[0]["PRODUCT"]["PROPERTIES"]["URL_PRODUCT"]["VALUE"]);
				}else{
					$changeFastBack.addClass("disabled");
					$changeCart.removeClass("added").addClass("disabled").addClass("requestPrice").html($("<span/>").html("Узнать скидку поставщика").prepend($("<img />").attr({src: TEMPLATE_PATH + "/images/request.svg", class: "icon"}))).attr("href", 'https://ad.admitad.com/g/17lxnyyakg5082102477c109c80522/?subid=elem_' + http[0]['PRODUCT']['ID'] + '&ulp=' + http[0]["PRODUCT"]["PROPERTIES"]["URL_PRODUCT"]["VALUE"]);
					$_mProduct.find(".fastBack").attr("href", 'https://ad.admitad.com/g/17lxnyyakg5082102477c109c80522/?subid=elem_' + http[0]['PRODUCT']['ID'] + '&ulp=' + http[0]["PRODUCT"]["PROPERTIES"]["URL_PRODUCT"]["VALUE"]);
					http[0]["PRODUCT"]["CAN_BUY"] = "N";
				}
