			...
			<div class="appFastViewColumnContainer">
				...
				<div class="appFastViewInformationColumn">
					...
					<?if(!empty($arResult["PRICE"])):?>
						...
						<?if($arResult["CATALOG_AVAILABLE"] != "Y"):?>
							<?if($arResult["CATALOG_SUBSCRIBE"] == "Y"):?>
								<a onclick="ym(21192229,'reachGoal','CLICK_OFFER');" target="_blank" href="/red.php?red=<?=urlencode('https://ad.admitad.com/g/17lxnyyakg5082102477c109c80522/?subid=fast_' . $arResult['ID'] . '&ulp=' . $arResult['PROPERTIES']['URL_PRODUCT']['VALUE'])?>" class="addCart subscribe" data-id="<?=$arResult["ID"]?>"><img src="<?=SITE_TEMPLATE_PATH?>/images/subscribe.png" alt="" class="icon">Узнать скидку поставщика</a>
							<?else:?>
								<a onclick="ym(21192229,'reachGoal','CLICK_OFFER');" target="_blank" href="/red.php?red=<?=urlencode('https://ad.admitad.com/g/17lxnyyakg5082102477c109c80522/?subid=fast_' . $arResult['ID'] . '&ulp=' . $arResult['PROPERTIES']['URL_PRODUCT']['VALUE'])?>" class="addCart disabled" data-id="<?=$arResult["ID"]?>"><img src="<?=SITE_TEMPLATE_PATH?>/images/incart.png" alt="" class="icon">Узнать скидку поставщика</a>
							<?endif;?>
						<?else:?>
							<a onclick="ym(21192229,'reachGoal','CLICK_OFFER');" target="_blank" href="/red.php?red=<?=urlencode('https://ad.admitad.com/g/17lxnyyakg5082102477c109c80522/?subid=fast_' . $arResult['ID'] . '&ulp=' . $arResult['PROPERTIES']['URL_PRODUCT']['VALUE'])?>" class="addCart" data-id="<?=$arResult["ID"]?>"><img src="<?=SITE_TEMPLATE_PATH?>/images/incart.png" alt="" class="icon">Узнать скидку поставщика</a>
						<?endif;?>
					...
					<div class="secondTool">
						...
						<?endif;?>
						<div class="row">
							<a onclick="ym(<?=$arTemplateSettings['TEMPLATE_METRICA_ID']?>,'reachGoal','<?=$arTemplateSettings['TEMPLATE_METRICA_ADD_CART']?>');" href="/red.php?red=<?=urlencode($arResult["PARTNER_LINK"] . '?subid=sect_' . $arResult['ID'] . '&ulp=' . $arResult['PROPERTIES']['URL_PRODUCT']['VALUE'])?>" class="label" data-id="<?=$arResult["ID"]?>"><img src="<?=SITE_TEMPLATE_PATH?>/images/fastBack.png" alt="<?=GetMessage("FAST_VIEW_FASTBACK_LABEL")?>" class="icon"><?=GetMessage("FAST_VIEW_FASTBACK_LABEL")?></a>
						</div>
						<div class="row">
